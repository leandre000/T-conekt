              ...
              >
                <div className="flex items-center gap-2">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src={other?.image || ""} alt={`${other?.firstName} ${other?.lastName}` || "U"} />
                    <AvatarFallback>{(other?.firstName?.charAt(0) || other?.lastName?.charAt(0) || "U").toUpperCase()}</AvatarFallback>
                  </Avatar>
                  <div>
                    <div className="font-semibold">{other?.firstName} {other?.lastName || "Conversation"}</div>
                  ...
                  <div className="flex items-end gap-2">
                    {!isMe && (
                      <Avatar className="h-7 w-7">
                        <AvatarImage src={sender?.image || ""} alt={`${sender?.firstName} ${sender?.lastName}` || "U"} />
                        <AvatarFallback>{(sender?.firstName?.charAt(0) || sender?.lastName?.charAt(0) || "U").toUpperCase()}</AvatarFallback>
                      </Avatar>
                    )}
